...
//Getting the permission status
        int RESULT_READ_PHONE_STATE = ContextCompat.checkSelfPermission(this, Manifest.permission.READ_PHONE_STATE);
        int RESULT_READ_CONTACTS = ContextCompat.checkSelfPermission(this, Manifest.permission.READ_CONTACTS);
        int RESULT_WRITE_CONTACTS = ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_CONTACTS);
        int RESULT_CAMERA = ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA);
        int RESULT_CALL_PHONE = ContextCompat.checkSelfPermission(this, Manifest.permission.CALL_PHONE);
        int RESULT_READ_EXTERNAL_STORAGE = ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE);

//If permission is granted returning true
        if (RESULT_READ_PHONE_STATE == PackageManager.PERMISSION_GRANTED
                && RESULT_READ_CONTACTS == PackageManager.PERMISSION_GRANTED
                && RESULT_WRITE_CONTACTS == PackageManager.PERMISSION_GRANTED
                && RESULT_CAMERA == PackageManager.PERMISSION_GRANTED
                && RESULT_CALL_PHONE == PackageManager.PERMISSION_GRANTED
                && RESULT_READ_EXTERNAL_STORAGE == PackageManager.PERMISSION_GRANTED)
            return true;
...
//            ActivityCompat.requestPermissions(this, new String[]{android.Manifest.permission.READ_PHONE_STATE}, REQUEST_READ_PHONE_STATE);
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        Log.d(TAG, " onRequestPermissonResult code " + requestCode + " : : " + READ_CONTACTS_PERMISSIONS_REQUEST + " :: " + grantResults.length + " :: " + grantResults[0] + " :: " + PackageManager.PERMISSION_GRANTED);
...
//                    finish();
            ...
            case READ_CONTACTS_PERMISSIONS_REQUEST: {
                ...
                /*~~~~~~~~~~~~~~~~~~~~~~~~~ to get permission Code before 04 - jan - 2018 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
                /*if (grantResults.length > 0
                        && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    // startAction();
                } else {
...
*/
                ...
                /*~~~~~~~~~~~~~~~~~~~~~~~~~ to get permission Code updated on 04 - jan - 2018 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
