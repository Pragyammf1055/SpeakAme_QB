...
public class ViewContact_DetailActivity extends AnimRootActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Status.equalsIgnoreCase("")) {
            mtextstatus.setText("Cant't talk speakameqb only");
        } else {
...
//        }
    ...
    private void imageDialog() {
        ...
        if (Image.equalsIgnoreCase("")) {
            imageView.setBackgroundResource(R.drawable.profile_default);

        } else {
            Picasso.with(this).load(Image).error(R.drawable.profile_default)
                    .resize(200, 200)
                    .into(imageView);
