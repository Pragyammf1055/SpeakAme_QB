...
import com.speakameqb.Adapter.CustomImageSelectAdapter;
...
public class ImageSelectActivity extends AlbumActivity {
    private final static String TAG = "ImageSelectActivity";
    ...
    private ActionMode.Callback callback = new ActionMode.Callback() {
        ...
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            ...
            menuInflater.inflate(R.menu.contact_display_menu, menu);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle("Tap to select images");
        }
        ...
        album = intent.getStringExtra(AppConstants.INTENT_EXTRA_ALBUM);
    ...
    protected void onStart() {
        ...
        observer = new ContentObserver(handler) {
            ...
            public void onChange(boolean selfChange) {
                Log.v(TAG, " Content Observer in onChange");
                loadImages();
            }
        };
    ...
    protected void onDestroy() {
        ...
        Log.v(TAG, " actionbar null, adaper releaseResource, grid lisner null ");
    }
    ...
    private void toggleSelection(int position) {
        if (!images.get(position).isSelected && countSelected >= AppConstants.limit) {
            Toast.makeText(getApplicationContext(), String.format(getString(R.string.limit_exceeded), AppConstants.limit), Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private ArrayList<Image> getSelected() {
        ...
        Log.v(TAG, " send ArrayList Image Data :- " + selectedImages);
    ...
    private void sendIntent() {
        ...
        bundle.putParcelableArrayList(AppConstants.INTENT_EXTRA_IMAGES, getSelected());
        intent.putExtras(bundle);
        Log.v(TAG, "getSelected............." + getSelected());
    ...
    private class ImageLoaderRunnable implements Runnable {
        ...
        public void run() {
            ...
            sendMessage(AppConstants.FETCH_COMPLETED, tempCountSelected);
        }
    }
