    ...
    private void loginAsync(QBUser user, final ProgressDialog dialog, final String status) {
        ...
        QBUsers.signIn(user).performAsync(new QBEntityCallback<QBUser>() {
            ...
            public void onSuccess(QBUser qbUser, Bundle bundle) {
                ...
                AppPreferences.setQBUserId(SignIn_Activity.this, qbUser.getId());
    ...
    private void createSession(String login, String pwd) {
        ...
        QBAuth.createSession(user).performAsync(new QBEntityCallback<QBSession>() {
            ...
            public void onSuccess(QBSession qbSession, Bundle bundle) {
                ...
                AppPreferences.setQBUserId(SignIn_Activity.this, qbSession.getUserId());
        ...
        QBPushNotifications.createSubscription(subscription).performAsync(
                new QBEntityCallback<ArrayList<QBSubscription>>() {
                    ...
                    public void onSuccess(ArrayList<QBSubscription> subscriptions, Bundle args) {
                        ...
                        AppPreferences.setQBFcmSubscribeId(SignIn_Activity.this, subscriptionId);
                        Log.i(TAG, "SIGN In Activity subscription id123 pref :- " + AppPreferences.getQBFcmSubscribeId(SignIn_Activity.this));

                        deleteSubscription(AppPreferences.getQBFcmSubscribeId(SignIn_Activity.this));
                    }
...
//                values.add(new BasicNameValuePair("android_id", Uniqueid));
            ...
            Log.d(TAG, "Json request login_value :- " + values.toString());
            ...
            try {
                ...
                if (jsonString != null) {
                    ...
                    if (jsonObj.getString("status").equalsIgnoreCase("200")) {
                        ...
                        Log.v(TAG, "Json Response Sign in :- " + jsonString);
...
//                final String countryCode = mCountryCode.getText().toString().trim();
                ...
                intent.putExtra("mobileNo_only", mobileNo);
                startActivity(intent);
                finish();
