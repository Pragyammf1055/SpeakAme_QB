...
import com.speakameqb.Classes.TimeAgo;
...
public class BroadcastnewgroupAdapter extends BaseAdapter {
    ...
    private static final String TAG = "Broadcastnewgroup";
    ...
    public BroadcastnewgroupAdapter() {
    }
...
//        messageCountTextView.setVisibility(View.VISIBLE);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        Log.v(TAG, "Time :- " + chatMessage.Time);
        Log.v(TAG, "Date :- " + chatMessage.Date);
        ...
        try {
            ...
            Log.v(TAG, "Date before conv :- " + date1);
            date1 = new SimpleDateFormat("yyyy-MM-dd, hh:mm aa").parse(sDate1);
            Log.v(TAG, "Date after conv :- " + date1);
            String sentTime = new TimeAgo(context).timeAgo(date1);
            Log.v(TAG, "Date after conv 1:- " + sentTime);
        ...
        try {
            ...
            Log.v(TAG, "Date after conversion 1 :-  " + date);
            txtminute.setText(date);
            Log.v(TAG, "Date after conversion 2 :-  " + date);

        } catch (ParseException e) {
            e.printStackTrace();
        }
        Log.v(TAG, "Date after conversion :-  " + date);
        txtminute.setText(date);
