...
import com.speakameqb.Activity.GroupMemberList_Activity;
...
public class NewGroupMember_Adapter extends RecyclerView.Adapter<NewGroupMember_Adapter.MyViewHolder> {
    ...
    public static ArrayList<String> contactNumberArrayList;
    ...
    public NewGroupMember_Adapter(Context context, ArrayList<AllBeans> contactList) {
        ...
        contactNumberArrayList = new ArrayList<String>();
    }
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (allBeans.isSelected()) {
            ...
            contactNumberArrayList.add(contactList.get(position).getFriendmobile());
        ...
        holder.checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isCheckeds) {
                    ...
                    contactNumberArrayList.remove(contactList.get(position).getFriendmobile());
