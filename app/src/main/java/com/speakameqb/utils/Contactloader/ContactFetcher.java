package com.speakameqb.utils.Contactloader;
...
public class ContactFetcher {
    ...
    public ArrayList<Contact> fetchAll() {
        ...
        Cursor cursor = context.getContentResolver().query(ContactsContract.Contacts.CONTENT_URI, projectionFields, null, null,
...
//        Cursor cursor = cursorLoader.loadInBackground();
    ...
    public void matchContactNumbers(Map<String, Contact> contactsMap) {
        ...
        if (phone.moveToFirst()) {
            ...
            Log.v(TAG, "Contact import from service number 123:- " + contactNumberColumnIndex);
            Log.v(TAG, "Contact import from service name 123 :- " + phone.getColumnIndex(Phone.DISPLAY_NAME));
