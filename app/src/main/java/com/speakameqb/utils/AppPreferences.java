...
public class AppPreferences {
    ...
    public static String getUSERLANGUAGE(Context context) {
        sharedPreferences = context.getSharedPreferences(
                MBPREFERENCES, 0);
        return sharedPreferences.getString(USERLANGUAGE, "");
    }
    ...
    public static String getFcmId(Context context) {
        SharedPreferences pereference = context.getSharedPreferences(
                MBPREFERENCES, 0);
        return pereference.getString(FCM_ID, "");

    }

    public static void setQBFcmSubscribeId(Context context, int id) {
        SharedPreferences preferences = context.getSharedPreferences(
                MBPREFERENCES, 0);
        Editor editor = preferences.edit();
        editor.putInt(FCM_SUBSCRIBE_ID, id);
        editor.commit();
    }

    public static int getQBFcmSubscribeId(Context context) {
        SharedPreferences pereference = context.getSharedPreferences(
                MBPREFERENCES, 0);
